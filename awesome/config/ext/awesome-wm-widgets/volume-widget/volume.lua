...
local utils = require("ext.awesome-wm-widgets.volume-widget.utils")
...
local widget_types = {
    icon_and_text = require("ext.awesome-wm-widgets.volume-widget.widgets.icon-and-text-widget"),
    icon = require("ext.awesome-wm-widgets.volume-widget.widgets.icon-widget"),
    arc = require("ext.awesome-wm-widgets.volume-widget.widgets.arc-widget"),
    horizontal_bar = require("ext.awesome-wm-widgets.volume-widget.widgets.horizontal-bar-widget"),
    vertical_bar = require("ext.awesome-wm-widgets.volume-widget.widgets.vertical-bar-widget")
}
local volume = {}
